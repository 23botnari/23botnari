...
function PLAT(IMAGE, P_API = false) {
    ...
    .attr("style","filter: brightness(1000%);")
}
...
function VBVB(AMO) {
    ...
    $("#SPLAT").attr("src", 
    "https://d13pxqgp3ixdbh.cloudfront.net/uploads/16529683600609ff3a5c98d8b2a1ac01c1e6129786.png")
    .attr("style","filter: brightness(1000%);")
...
$(function () {
    ...
    BAR = new ProgressBar.Line(PRO, {
        ...
        trailColor: "#262626",
        trailWidth: 6,
        svgStyle: { padding:"0 0 20px 1%", width: "99%", height: "50px" }
    });
...
function S2() {
    ...
    if (!USERNAME || !SELECTED_PLATFORM) {
        ...
        alert("Enter your username and select your platform.")
...
function END() {
    ...
    if (XY == 1) {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        ...
                        $("#CTEXT").addClass("animate__" + TRANSITION1 + "Out");
                        //Generated GAME MONEY LOGO
                        $("#FINAL_IMG").attr("src", "https://bucket.cpabuild.com/uploads/1585660223adc6d4f981dffc01a3af14cd061be52e.png");
        ...
        //$("#US").append('<div class=" 2 w-full relative mx-auto p-2 PURPLEFLICK drop-shadow-2xl mb-2"> <input type="text" disabled class=" w-full bg-neutral-50 text-neutral-800 text-center  2 px-2 pt-3 pb-1 text-2xl uppercase text-shadow-sm" value="' + USERNAME + '"> </div>')

        //$("#PL").append('<div class="PURPLEFLICK w-full   relative p-1 drop-shadow-xl"> <div class="BGFLICK   w-full"> <img src="var/img/switch.png" class="mx-auto w-1/2 py-4"> </div> </div>')
...
function LAST() {
    // Transfering GAME MONEY
    $("#TEXTEND").text(USERNAME + ", you are almost finished! To finish transfering " + SELECTED_VB + " VBUCKS to your account click the Verify button below and follow instructions.")
    ...
    $("#PL3").removeClass("BGFLICK").addClass("bg-[#]");
    ...
    $("#IQOS2").removeClass("BGFLICK").addClass("bg-[#]");
